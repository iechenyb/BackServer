...
public class Pagination2 implements Serializable{
    ...
    public static void main(String[] args) {
    	new Pagination2(20,15,300);
    	/*ReflectUtils.printNameValueOfObject(new Pagination(10,20,300));
    	ReflectUtils.printNameValueOfObject(new Pagination(15,20,300));
    	ReflectUtils.printNameValueOfObject(new Pagination(15,20,303));*/
	}
}